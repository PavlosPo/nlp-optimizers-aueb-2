...
def preprocess_function(examples):
    ...
    model_inputs = tokenizer(inputs, padding='max_length', max_length=max_length)
    labels = tokenizer(text_target=examples["highlights"], padding='max_length', max_length=max_length)
